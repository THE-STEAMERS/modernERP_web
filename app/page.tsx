  ...
  return (
    <div className="flex sm:min-h-[85.5vh] min-h-[85vh] flex-col items-center justify-center text-center px-2 sm:py-8 py-12">
      ...
      <h1 className="text-3xl font-bold mb-4 sm:text-6xl">
        HIGH LEVEL SYSTEM FOR A MODERN ERP PLATFORM
      </h1>
      <p className="mb-8 sm:text-lg max-w-[800px] text-muted-foreground">
      Here’s a high-level system for a accounting software, including key functionalities, modules, and interactions. This design ensures scalability, ease of development, and future enhancements.
      </p>
